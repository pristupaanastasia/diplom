	...
	:QWidget(parent,name)
{
	...
	archiv->setFont(QFont("Times",10,QFont::Bold));
	...
	px_bit_text->setFont(QFont("Times",10,QFont::Bold));
	px_text_x = new QLabel("x",this);
	px_text_x->setFont(QFont("Times",10,QFont::Bold));
	...
	px_text_y->setFont(QFont("Times",10,QFont::Bold));
	...
	kadr->setFont(QFont("Times",10,QFont::Bold));
